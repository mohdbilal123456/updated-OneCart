...
function Sidebar() {
  ...
  return (
    <>
      ...
      <div className='w-[18%] min-h-[100vh] border-r-[1px] py-[60px] border-[#D7D6D6] fixed left-0 top-0'>
            <div className='flex flex-col gap-4 text-white pt-[40px] pl-[20%] text-[15px]'>
